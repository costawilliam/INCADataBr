...
numeroCasosPorLocalizacaoAgrupada <- function(...) {
  ...
  desc <- c(
    "Labio, cavidade oral",
    "Orofar, Nasofar, Rinofar e Laringe",
    "Orgaos digestivos ",
    "Ap.resp,org intrat exceto laringe",
    "Ossos, articulacoes, cartilagens artic",
    "Sistema hematopoetico",
    "Pele",
    "Nervos perifericos e SNA",
    "Retroperitonio e Peritonio",
    "Tec conjunto,subcutaneo,outros tec moles",
    "Mama",
    "Orgaos genitais femininos",
    "Orgaos genitais masculinos",
    "Trato urinario",
    "Olho, cerebro e outras partes do SNC",
    "Tiroide e outras glandulas",
    "Out. localizacoes e localizacoes mal definidas",
    "Linfonodos",
    "Localizacao primaria desconhecida"
  )

  df <- data.frame(df, desc)
